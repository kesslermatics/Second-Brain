...
async def generate_lesson_notes(
    ...
    prompt = f"""Du bist ein Second Brain Assistent. Basierend auf dem folgenden Unterrichtsgespräch
sollst du ATOMIC NOTES erstellen.
...
async def generate_term_note(
    ...
    prompt = f"""Du bist ein Second Brain Assistent. Erstelle eine ATOMIC NOTE zum folgenden Begriff:
